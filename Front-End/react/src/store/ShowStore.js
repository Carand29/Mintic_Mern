                        ...
                        <tbody>
                            {products.map((product, index)=>(
                                <tr key={index}>
                                    ...
                                    <td>{product.stock}</td>
                                    <td>
                                        <button onClick={()=>getCarById(product._id)} className="btn btn-outline-primary">Agregar</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
                        ...
                        <tbody>
                            {
                                cars.map((car, index)=>(
                                    <tr key={index}>
                                        ...
                                        <td>{car.precio}</td>
                                        <td>
                                            <button onClick={()=>deleteCar(car._id)} className="btn btn-outline-danger">Eliminar</button>
                                        </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <Link to="/buy/" className="btn btn-warning">Comprar</Link>
                                </td>
