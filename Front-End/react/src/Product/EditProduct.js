...
const CompEditProducts = ()=>{
    ...
    const update = async (e)=>{
        e.preventDefault();
        await axios.put(URI+id, {nombre:nombre, clasificacion:clasificacion, precio:precio, stock:stock });
    ...
    return(
        <div>
            ...
            <form onSubmit={update}>            
                ...
                <div className="row mb-2 justify-content-center">
                        <label className="col-sm-2 col-form-label col-form-label-sm">Clasificación</label>
                        <div className="col-sm-4">
                            <input
                                value={clasificacion}
